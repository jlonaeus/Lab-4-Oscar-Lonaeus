...
<main>
    <h2>Which of Vermont's Wildlife would you like to Update?</h2>
    <?php
    if(is_array($animals)){
        foreach($animals as $animal){
            print '<figure class="animals">';
            print '<a href="updateCritter.php?cid=' . $animal['pmkWildlifeId'] . '"><img alt="' . $animal['fldCommonName'] . '" src="images/' . $animal['fldMainImage'] . '"></a>';
